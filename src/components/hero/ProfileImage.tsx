...
const ProfileImage: React.FC = () => {
  return (
    <motion.div
      ...
      className="relative w-fit mx-auto h-[90vh]"
    >
      <style>
        {`
          @keyframes slowPulse {
      ...
      <div className="relative h-full aspect-[3/4] bg-gradient-to-r from-ctp-surface0 to-ctp-surface1 rounded-[40px] sm:rounded-[60px] p-1.5 backdrop-blur-xl shadow-2xl">
        ...
        <img
          ...
          className="w-full h-full object-cover rounded-[36px] sm:rounded-[56px] shadow-inner"
        />
      </div>
    </motion.div>
  );
